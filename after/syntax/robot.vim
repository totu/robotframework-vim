...
" Other libraries
syn match koneLibrary             "\c\<\(Before\|After previous message action\|After\)\>"
syn match robotOperator             "\c\<\(mqtt\)\>[a-zA-Z .]*  "
...
syn region robotComment     display start="#\|comment\|Comment" excludenl end="$"
...
hi def link robotOperator           Identifier
...
hi def link koneLibrary              Keyword
